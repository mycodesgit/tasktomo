<div class="chart-grid">
    <div class="chart-card">
        <div class="chart-card-header">
            <h4 class="text-left" id="timeHeader">Add New user</h4>
        </div>
        <div class="">
    ...
    <div class="chart-card">
        <div class="chart-card-header">
            <h4 class="text-left" id="timeHeader">User's List</h4>
        </div>
        <div class="">
            <div class="dashboard-table-header">
            </div>
            <div>
                <table id="userTable" class="table table-hover" width="100%" style="font-size: 10pt;">
                    <thead>
                        <tr>
                            <th>No.</th>
                            <th>First Name</th>
